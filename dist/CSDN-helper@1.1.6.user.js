...
// ==/UserScript==
        ...
        // 当前登陆用户的账号
        var myName = document.querySelector("#csdn-toolbar > div > div > div.toolbar-btns.onlyUser.csdn-toolbar-fr > div.toolbar-btn-login.csdn-toolbar-fl.toolbar-subMenu-box > div > a:nth-child(5)").href.split("blog.csdn.net/")[1];
        // 文章的作者账号
